...
const IncidentForms = () => {
      ...
      return (
            <section className={`  absolute top-50  ${ !isFormOpen ? ' translate-y-full ' :  ''} left-0 z-1000 flex flex-col gap-6 w-full h-full p-4 bg-form text-label rounded-t-2xl transition-transform duration-150 `}>
